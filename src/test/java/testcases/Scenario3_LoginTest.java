...
public class Scenario3_LoginTest extends BaseTest {
    private static final Logger logger = LogManager.getLogger(Scenario3_LoginTest.class);

    @Test(priority = 3, description = "TC003 Verify user login functionality.")
