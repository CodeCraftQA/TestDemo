...
public class Scenario5_HomePageLinksTest extends BaseTest {
    private static final Logger logger = LogManager.getLogger(Scenario5_HomePageLinksTest.class);

    @Test(priority = 10, description = "Test Case For Testing All the HomePage Links are Accessible")
